    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/posts/{{ $post->slug }}" class="mb-5">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="slug" name="slug" @error('slug') is-invalid @enderror
            ...
            <div class="mb-3">
                ...
                @enderror
                <input id="body" type="hidden" name="body" @error('body') is-invalid @enderror required
